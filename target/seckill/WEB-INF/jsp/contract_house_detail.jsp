    ...
    <form id="form" data-toggle="validator" class="form-horizontal" role="form"
                            ...
                            <c:forEach items="${contract.tableList1}" var="b">
                                ...
                                <tr>
                                    <td><input
                                            ...
                                            onclick="search(this)" disabled id="l${b.table0}" type="text"
                                            value="${b.table1}"
                                            style=""
                                            name="loc1"/></td>
        ...
        <div class="panel panel-default    col-sm-10 col-sm-offset-1">
            <div class="panel-body">
                ...
                <div class="form-group">
                    <div class="table-responsive col-md-9 col-md-offset-1" id="table"
                         style="clear: both;margin-top: 30px">
                        <table class="table">
                            ...
                            <c:forEach items="${freeList}" var="f">
                                <tr>
                                    ...
                                    <td nowrap="nowrap"><a data-toggle="modal" data-target="#freeModal"
                                                           style="color: #1d4499">详情</a>
                                    </td>
                                </tr>
                            </c:forEach>
        ...
        <div class="form-group">
            <div class=" col-sm-10 col-sm-offset-1">
                ...
                <c:if test="${approval=='confirm'}">
                    ...
                    <button style="float: right" type="button" class="mui-btn mui-btn-primary " onclick="back()"> 返回
                        ...
                        <button style="float: right;margin-left: 3%" type="button" class="mui-btn mui-btn-primary "
                                onclick="downloadContract('${contract.no}')"> 下载合同
                        </button>
                ...
                <c:if test="${approval=='cancel'}">
                    ...
                    <button style="float: right;margin-left: 3%;margin-right: 3%" type="button" class="mui-btn mui-btn-primary "
                            onclick="downloadContract('${contract.no}')"> 下载合同
                    </button>
                ...
                <c:if test="${approval=='normal'}">
                    ...
                    <label style="float: right;" class="control-label">审核人:<span
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
                                        ...
                                        <table class="table">
                                            ...
                                            <c:forEach items="${contract.tableList11}" var="b">
                                                <tr id="${b.table7}t11">
                                                    ...
                                                    <td><input id="${b.table7}d11" disabled onchange="dischange11(this)"
                                                               style="border-bottom: 1px solid #dbdbdb;border-top:0px;border-left:0px;border-right:0px;border-radius:0;text-align:center"
                                        ...
                                        <table class="table">
                                            ...
                                            <c:forEach items="${contract.tableList22}" var="b">
                                                <tr id="${b.table4}r22">
                                                    ...
                                                    <td><input onchange="dischange22(this)" disabled
                                                               style="border-bottom: 1px solid #dbdbdb;border-top:0px;border-left:0px;border-right:0px;text-align: center;border-radius:0;"
            ...
            <span style="height: 30px;" class="glyphicon glyphicon-th"></span></span></div>
                    ...
                    <%--<div class="form-group">--%>
                    <%--<label style="font-size: 20px;" class="col-md-4 control-label">租赁费用合计:<span--%>
                                        ...
                                        <table class="table">
                                            ...
                                            <c:forEach items="${contract.tableList44}" var="b">
                                                <tr id="${b.table5}t44">
                                                    ...
                                                    <td><input name="useArea44" disabled type="hidden"
                                                               value="  useArea  ">
                                                        <input disabled
                                                               value="${b.table3}"
                                                               style="border-bottom: 1px solid #dbdbdb;border-top:0px;border-left:0px;border-right:0px;border-radius:0;text-align:center"
...
<script type="text/javascript" charset="utf-8">
    ...
    function downloadContract(no) {
        var url = '/seckill/download/' + no
        mui.openWindow({
            url: url
