    ...
    <form class="form-horizontal" role="form" style="margin-top: 5%;margin-left: 3%;margin-right: 3%;">
        <div class="form-group">
            ...
            <div class="col-sm-6">
                ...
                <input type="text" class="form-control" id="name" value="${name}" placeholder="请输入部门名称">
            ...
            <div class="col-sm-offset-2 col-sm-4">
                ...
                <c:choose>
                    <c:when test="${id>-1}">
                        ...
                        <button type="button" class="mui-btn mui-btn-primary" onclick="modify()"> 修改部门</button>
                    </c:when>
                    <c:otherwise>
...
<script type="text/javascript" charset="utf-8">
    ...
    function confirm() {
        ...
        var url = "/seckill/department/" + name +'/'+ company+"/add"
        $.post(url, {}, function (result) {
            if (result == 1) {
                sessionStorage.setItem("need-refresh", true);
                location.href = document.referrer;                window.history.back();
