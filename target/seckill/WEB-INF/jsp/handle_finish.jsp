...
<div class="mui-content">
    ...
    <div class="form-inline" style="margin-top: 20px">
        ...
        <div style="float: right;margin-right: 5%;" class=" form-group">
            <label for="code" style="display: inline;color: #ff0000" class="form-label">已核销</label>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <c:if
                           ...
                           onclick="updateContract('${list.codeAuto}','${list.remark}','${list.customId}','${list.id}')">详情 </a>
...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready(function () {
        ...
        $("#page-container-static-big").on("pageChanged", function (event, params) {
            ...
            if (query == 'query') {
                ...
                $(window).attr('location', '/seckill/handle_finish/' + userId + '/' + (params.pageNum - 1) + '/' + code + '/' + startDate + '/' + endDate);

            } else {

                $(window).attr('location', '/seckill/handle_finish/' + userId + '/' + (params.pageNum - 1));
    ...
    function updateContract(codeAuto, remark, id, contractId) {
        if (remark == '') {
            remark = 'fantasy';
        }
        var url = "/seckill/handle_receivable_detail_after/" + codeAuto + "/" + remark + "/" + userId + "/" + id + "/" + contractId + "/update";
        mui.openWindow({
            url: url
    ...
    function queryContract() {
        ...
        var url = "/seckill/handle_finish/" + userId + '/0/' + code + '/' + startDate + '/' + endDate;
        mui.openWindow({
            url: url
