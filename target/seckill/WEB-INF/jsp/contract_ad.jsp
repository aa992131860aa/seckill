...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready(function () {
        ...
        $("#page-container-static-big").on("pageChanged", function (event, params) {
            ...
            if (query == 'query') {
                ...
                $(window).attr('location', '/seckill/contract_ad/' + userId + '/' + (params.pageNum - 1) + '/' + code + '/' + linkMan + '/' + no+ '/' + startDate + '/' + endDate  + '/query/noExport');

            } else {

                $(window).attr('location', '/seckill/contract_ad/' + userId + '/' + (params.pageNum - 1)+'/noExport');
    ...
    function excelExport() {
        ...
        if (query == 'query') {
            ...
            var url ='/seckill/contract_ad/' + userId + '/' + page + '/' + code + '/' + linkMan + '/' + no + '/' + startDate + '/' + endDate + '/query/export';
            ...
            var url= '/seckill/contract_ad/' + userId + '/'+page+'/export';
            mui.openWindow({
                url: url
    ...
    function skipContractHouse() {
        mui.openWindow({
            url: '/seckill/contract_ad/insert'
        })

    }

    function updateContract(uuid) {
        var url = "/seckill/contract_ad/" + uuid + "/update";
        mui.openWindow({
            url: url
    ...
    function detailContract(uuid) {
        var url = "/seckill/contract_ad/" + uuid + "/normal/detail";
        mui.openWindow({
            url: url
    ...
    function updateCustom(uuid) {
        ...
        var url = "/seckill/contract_ad/" + uuid + "/0/del/"+date+"/0";
        mui.openWindow({
            url: url
    ...
    function queryContract() {
        ...
        if (code == '' && linkMan == '' && no == ''&&startDate==''&&endDate=='') {
            ...
            var url = "/seckill/contract_ad/" + userId + '/0/' + code + '/' + linkMan + '/' + no+ '/' + startDate + '/' + endDate + "/query/noExport";
            mui.openWindow({
                url: url
