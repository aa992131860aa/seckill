        ...
        <table class="table">
            ...
            <c:forEach items="${contractList}" var="list">
                <tr>
                    ...
                    <td>
                        <a
                                onclick="updateContractDetaill('${list.uuid}','${list.style}')">详情  </a>
...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready(function () {
        ...
        $("#page-container-static-big").on("pageChanged", function (event, params) {
            ...
            if (query == 'query') {
                ...
                $(window).attr('location', '/seckill/contract_cancel/' + userId + '/' + (params.pageNum - 1) + '/' + code + '/' + linkMan + '/' + no + '/' + startDate + '/' + endDate + '/query/noExport');

            } else {

                $(window).attr('location', '/seckill/contract_cancel/' + userId + '/' + (params.pageNum - 1)+'/noExport');
    ...
    function excelExport() {
        ...
        if (query == 'query') {
            ...
            var url ='/seckill/contract_cancel/' + userId + '/' + page + '/' + code + '/' + linkMan + '/' + no + '/' + startDate + '/' + endDate + '/query/export';
            ...
            var url= '/seckill/contract_cancel/' + userId + '/'+page+'/export';
            mui.openWindow({
                url: url
    ...
    function skipContractHouse() {
        mui.openWindow({
            url: '/seckill/contract_cancel/insert'
        })

    }


    function updateContractDetaill(uuid,style) {
        var url = "/seckill/contract_"+style+"/" + uuid + "/normal/detail";
        mui.openWindow({
            url: url
    ...
    function updateContract(uuid) {
        var url = "/seckill/contract_cancel/" + uuid + "/update";
        mui.openWindow({
            url: url
    ...
    function updateCustom(uuid) {
        var url = "/seckill/contract_cancel/" + uuid + "/del";
        mui.openWindow({
            url: url
    ...
    function queryContract() {
        ...
        if (code == '' && linkMan == '' && no == '' && startDate == '' && endDate == '') {
            ...
            var url = "/seckill/contract_cancel/" + userId + '/0/' + code + '/' + linkMan + '/' + no + '/' + startDate + '/' + endDate + "/query/noExport";
            mui.openWindow({
                url: url
