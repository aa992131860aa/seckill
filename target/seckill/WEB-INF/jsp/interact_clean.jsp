...
<div class="mui-content">
    ...
    <div class="form-group-sm" style="margin-top: 30px;margin-left: 30px;">
        ...
        <label style="float: left;" class=" control-label">保洁时间:${date}</label>
...
//  url: '/seckill/interact_clean/' + userId + '/0/clean/clean'
            $(window).attr('location', '/seckill/interact_clean/'+userId+'/' + (params.pageNum - 1) + '/clean/clean');
    ...
    function scan() {
        wx.scanQRCode({
            ...
            success: function (res) {
                ...
                // 回调
                mui.openWindow({
                    url: '/seckill/interact_clean/' + resultStr + '/insert/insert'
