...
<header class="mui-bar mui-bar-nav">
    ...
    <h1 class="mui-title">车位合同--应付录入单</h1>
    ...
    <form id="form" data-toggle="validator" class="form-horizontal" role="form"
        ...
        <div class="panel panel-default     col-sm-10 col-sm-offset-1">
            <div class="panel-body">
                ...
                <%--style="color: #f00">100</span></label>--%>
                <%--</div>--%>
        ...
        <div class="panel panel-default     col-sm-10 col-sm-offset-1  ">
            <div class="panel-body">
                <div class="form-group col-md-10" style="margin-top: 0px;margin-bottom: 0px;">
                    <label for="name" class="col-md-offset-1 control-label">费用清算</label>
                ...
                <div class="form-group">
                    <div class="table-responsive col-md-10 col-md-offset-1" style="clear: both;margin-top: 30px">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input disabled style="width: 20px;height: 20px;" name="checkbox" id="freeMoney"
                                           onclick="free()"    <c:if test="${contract.isFree==1}"> checked </c:if>
                                           type="checkbox">
                                </td>
                            </tr>
                            ...
                            <%--<td><input disabled="disabled"--%>
                            <%--style="border-bottom: 1px solid #dbdbdb;border-top:0px;border-left:0px;border-right:0px;border-radius:0;text-align:center"--%>
                            <%--id="uId " type="text" value="${loop.index}" name="useArea1"/></td>--%>
                        ...
                        <div class="table-responsive col-sm-10 col-sm-offset-1" style="clear: both;margin-top: 30px">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td><input
                                            style="border-bottom: 1px solid #dbdbdb;border-top:0px;border-left:0px;border-right:0px;border-radius:0;text-align:center" value="${allTotal}"
                ...
                <%--</div>--%>
                <div class="form-group">
                    <textarea id="freeReason" style="display: none;" rows="3" placeholder="申免理由">${contract.freeReason}</textarea>
                </div>
