...
<header class="mui-bar mui-bar-nav">
    ...
    <h1 class="mui-title">
        ...
        <c:if test="${insert=='insert'}">巡检新增</c:if>
        <c:if test="${insert=='update'}">巡检修改</c:if>
        <c:if test="${insert=='detail'}">巡检详情</c:if>
    </h1>
...
<div class="mui-content">
    ...
    <form id="form" data-toggle="validator" class="form-horizontal" role="form"
        ...
        <div class="form-group">
            <label for="sale" class="control-label" style="font-size: 12px">签字拍照,问题拍照上传(点击图片删除)</label>
            <button <c:if test="${insert=='detail'}"> disabled </c:if> type="button" style="float: right;"
                                                                       class="mui-btn mui-btn-outlined mui-btn mui-btn-primary"
        ...
        <div class="form-group">
            <div id="photolist" style="float: left">
                ...
                <c:forEach items="${safe.urlsList}" var="list" varStatus="c">
...
<script type="text/javascript" charset="utf-8">
    ...
    function confirm() {
        ...
        $(".new_photo").each(function (index) {
            ...
            if (srcurl.indexOf("/download/") != -1) {
                ...
                if (len == 0) {
                    ...
                    var url = "/seckill/interact_dot/" + id + "/" + dot + "/" + isNormal + "/" + content + "/" + srcUrls + "/" + usrName + "/" + insert;
        ...
        if ($(".new_photo").length == 0) {
            ...
            var url = "/seckill/interact_dot/" + id + "/" + dot + "/" + isNormal + "/" + content + "/" + srcUrls + "/" + userName + "/" + insert;
