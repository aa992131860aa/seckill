        ...
        <table class="table">
            ...
            <c:forEach items="${contractList}" var="list">
                <tr>
                    ...
                    <td>
                        <a onclick="updateContractDetaill('${list.uuid}','${list.style}')">详情 </a>
...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready(function () {
        ...
        $("#page-container-static-big").on("pageChanged", function (event, params) {
            ...
            $(window).attr('location', '/seckill/contract_house_warn/' + userId + '/' + (params.pageNum - 1)) + '/query';
