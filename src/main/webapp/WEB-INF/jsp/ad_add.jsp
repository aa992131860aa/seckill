...
<header class="mui-bar mui-bar-nav">
    ...
    <c:choose>
        <c:when test="${id>-1}">
            <h1 class="mui-title">广告类型修改</h1>
        </c:when>
        <c:otherwise>
            <h1 class="mui-title">广告类型新增</h1>
        </c:otherwise>
...
<div class="mui-content">
    ...
    <form class="form-horizontal" role="form" style="margin-top: 5%;margin-left: 3%;margin-right: 3%;">
        <div class="form-group">
            <label for="name" class="col-sm-2 control-label">广告类型</label>
            <div class="col-sm-6">

                <input type="text" class="form-control" id="name" value="${name}" placeholder="请输入广告类型">
            ...
            <div class="col-sm-offset-2 col-sm-4">
                ...
                <c:choose>
                    <c:when test="${id>-1}">
                        ...
                        <button type="button" class="mui-btn mui-btn-primary" onclick="modify()"> 修改广告类型
                        </button>
                    </c:when>
                    <c:otherwise>
