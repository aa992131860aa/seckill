...
<div class="mui-content">
    ...
    <form id="form" data-toggle="validator" class="form-horizontal" role="form"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <input type="number" class="form-control " id="warnDay" disabled style="background-color: #fff"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                ...
                <textarea rows="3"   <c:if test="${approval=='normal'}">disabled</c:if>  id="explain" placeholder="审批说明或意见">${contract.explain}</textarea>
                            ...
                            <c:forEach items="${contract.tableList1}" var="b">
                                ...
                                <tr>
                                    ...
                                    <td><input disabled="disabled"
                                               style="border-bottom: 1px solid #dbdbdb;border-top:0px;border-left:0px;border-right:0px;border-radius:0;text-align:center"
                                               id="uId " type="text" value="${b.table11}" name="number1"/></td>
                                    <td><select style="width: 120px;padding-left: 40px;" disabled
                                                class="form-control "
                                                name="goodsStatus1">
                                    ...
                                    <td><input disabled="disabled"
                                               style="border-bottom: 1px solid #dbdbdb;border-top:0px;border-left:0px;border-right:0px;border-radius:0;text-align:center"
                                               id="uId " type="text" value="${b.table8}" name="person1"/></td>
                                    <td><input disabled="disabled"
                                               style="border-bottom: 1px solid #dbdbdb;border-top:0px;border-left:0px;border-right:0px;border-radius:0;text-align:center"
                                               id="uId " type="text" value="${b.table9}" name="phone1"/></td>
                                    <td><input disabled="disabled"
                                               style="border-bottom: 1px solid #dbdbdb;border-top:0px;border-left:0px;border-right:0px;border-radius:0;text-align:center"
                                               id="uId " type="text" value="${b.table10}" name="num1"/></td>
                                    <td>
            ...
            <div class=" col-sm-10 col-sm-offset-1">
                ...
                <c:if test="${approval=='confirm'}">
                    ...
                    <button style="float: right" type="button" class="mui-btn mui-btn-primary " onclick="back()"> 返回
                        <button style="float: right;margin-left: 3%;margin-right: 3%" type="button" class="mui-btn mui-btn-primary " onclick="deal(1)"> 确定审核</button>
                        <button style="float: right" type="button" class="mui-btn mui-btn-primary " onclick="deal(-1)"> 驳回审核</button>
                        <label style="float: right;margin-right: 3%" class="control-label">审核人:<span id="userName"></span></label>
                    </button>
                </c:if>
                ...
                <c:if test="${approval=='cancel'}">
                    ...
                    <button style="float: right" type="button" class="mui-btn mui-btn-primary " onclick="back()"> 返回</button>
                    <button style="float: right;margin-left: 3%;margin-right: 3%;" type="button" class="mui-btn mui-btn-primary " onclick="deal(-1)"> 撤销审核</button>
                ...
                <c:if test="${approval=='normal'}">
                    ...
                    <button style="float: right;margin-left: 3%" type="button" class="mui-btn mui-btn-primary " onclick="back()"> 返回</button>
                    <label style="float: right;"  class="control-label">制单人:<span id="userName1">${contract.userName}</span></label>
                                        ...
                                        <table class="table">
                                            ...
                                            <c:forEach items="${contract.tableList11}" var="b">
                                                <tr id="${b.table6}t11">
                                                    ...
                                                    <td><input onchange="dischange11(this)" disabled
                                                               style="border-bottom: 1px solid #dbdbdb;border-top:0px;border-left:0px;border-right:0px;border-radius:0;text-align:center"
                                                    ...
                                                    <td><input disabled="disabled"
                                                               style="border-bottom: 1px solid #dbdbdb;border-top:0px;border-left:0px;border-right:0px;border-radius:0;text-align:center"
                                                               type="text" name="car11" value="${b.table4}"/></td>
                                                    <td><input disabled="disabled"
                                                               style="border-bottom: 1px solid #dbdbdb;border-top:0px;border-left:0px;border-right:0px;border-radius:0;text-align:center"
                                                               type="text" name="linkMan11" value="${b.table5}"/></td>
                                                </tr>
                                            </c:forEach>
                                            </tbody>
                                        </table>
...
<script type="text/javascript" charset="utf-8">
    ...
    function search(obj) {
        ...
        $("#" + obj.id).autocomplete({
            // searchStreedRoad_auto 输入框id
            source: function (request, response) {
                var url = '/seckill/contract_car/' + request.term + '/loc';
                console.log(url)
    ...
    function confirm() {
        ...
        var main = code_auto + flag2 + remark + flag2 + linkMan + flag2 + phone + flag2 + startDate + flag2 + endDate + flag2 + warnDay + flag2 + code + flag2 + type + flag2 + userName;
        ...
        if (type == 'insert') {
            var url = "/seckill/contract_car/" + main + "/" + table1
