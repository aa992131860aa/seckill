...
<div class="mui-content">
    ...
    <button style="margin-left: 30px;margin-top: 30px" type="button" class="mui-btn mui-btn-primary" onclick="skip_ad_add()">
        广告类型
    </button>
        ...
        <table class="table">
            ...
            <c:forEach items="${adList}" var="list">
                <tr>
                    ...
                    <td><a onclick="modifyAd('${list.id}','${list.name}')">修改</a> | <a
                            onclick="deleteAd(${list.id})" style="color: #f00;">删除</a></td>
...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready(function () {
        ...
        $("#page-container-static-big").on("pageChanged", function (event, params) {
            ...
            $(this).data("page").refresh(params);
                ...
                $(window).attr('location', '/seckill/ad/'+ (params.pageNum - 1) + '/query');
    ...
    function modifyAd(id, name) {

        mui.openWindow({
            url: '/seckill/ad/' + id + '/' + name + '/modify',
            id: 'department',
