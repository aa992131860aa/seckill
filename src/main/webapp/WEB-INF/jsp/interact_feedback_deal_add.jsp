...
<div class="mui-content">
    ...
    <form id="form" data-toggle="validator" class="form-horizontal" role="form"
        ...
        <div class="form-group">
            ...
            <input value="0"
                   disabled
            <c:if test="${feedback.type==0}"> checked </c:if>
            ...
            <input
                    disabled
            <c:if test="${feedback.type==1}"> checked </c:if>
        ...
        <div class="form-group">
            ...
            完成
            <input id="isDeal"
                   <c:if test="${feedback.isDeal==1}">checked</c:if>
...
<script type="text/javascript" charset="utf-8">
    ...
    function confirm() {
        ...
        var url = "/seckill/interact_feedback_deal/" + feedbackId + "/" + contents + "/" + userName + "/" + dates + "/" + isDeal + "/insert";
