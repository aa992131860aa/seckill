...
<div class="mui-content">
    ...
    <button style="margin-left: 30px;" type="button" class="mui-btn mui-btn-primary" onclick="skip_department_add()">
        新增部门
    </button>
        ...
        <table class="table">
            ...
            <c:forEach items="${departmentList}" var="list">
                <tr>
                    ...
                    <td><a onclick="modifyDepartment('${list.id}','${list.name}')">修改</a> | <a
                            onclick="deleteDepartment(${list.id})" style="color: #f00;">删除</a></td>
...
<script type="text/javascript" charset="utf-8">
    ...
    function modifyDepartment(id, name) {
        ...
        mui.openWindow({
            url: '/seckill/department/' + id + '/' + name + '/modify',
            id: 'department',
    ...
    function deleteDepartment(id) {
        ...
        mui.confirm('真的要删除吗？', '', new Array('取消', '确定'), function (e) {
            if (e.index == 0) {
                ...
                var url = "/seckill/department/" + id + "/delete";
