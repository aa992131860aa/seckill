...
<header class="mui-bar mui-bar-nav">
    ...
    <h1 class="mui-title">车位合同管理--终止撤销</h1>
    ...
    <form id="form" data-toggle="validator" class="form-horizontal" role="form"
        ...
        <div class="panel panel-default     col-sm-10 col-sm-offset-1  ">
            <div class="panel-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                            ...
                                            style="border-bottom: 1px solid #dbdbdb;border-top:0px;border-left:0px;border-right:0px;border-radius:0;text-align:center"
                                            id="payOutId" <c:if test="${isPay==0}"> placeholder="请输入应付金额"</c:if> <c:if
                                            test="${isPay==1||isPay==-1}"> disabled </c:if> type="number"
                                            onchange="payOut()"
                                            name="useArea1"/>

                                </td>
                                <td>
                                    <input style="width: 20px;height: 20px;" name="checkbox" id="freeMoney"
                                           onclick="free()"
                ...
                <%--</div>--%>
                <div class="form-group">
                    <label class="control-lable col-sm-offset-1">申免金额(单位/元):
                        <input id="payFree"
                               <c:if test="${isPay==1||isPay==-1}">disabled</c:if>
...
<script type="text/javascript" charset="utf-8">
    ...
    function setContractEndDate() {
        ...
        var uuid = '${uuid}';
        var url = "/seckill/contract_car/" + uuid + "/0/del/" + date + "/" + dateCount;
        mui.openWindow({
            url: url
        })
    }
